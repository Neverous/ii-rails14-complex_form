...
class MilestonesControllerTest < ActionController::TestCase
  ...
  test "should create milestone" do
    assert_difference('Milestone.count') do
      post :create, milestone: { description: @milestone.description, project_id: @milestone.project_id, title: @milestone.title }
    end
  ...
  test "should update milestone" do
    patch :update, id: @milestone, milestone: { description: @milestone.description, project_id: @milestone.project_id, title: @milestone.title }
    assert_redirected_to milestone_path(assigns(:milestone))
  end
